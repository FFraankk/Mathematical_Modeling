...
file1_path = r'D:\Mathematical_Modeling\MCM2024\CUMCM2024Problems\A题\Solution\result2逼近位置.xlsx'
df1.to_excel(file1_path, index=False, header=False)
file2_path = r'D:\Mathematical_Modeling\MCM2024\CUMCM2024Problems\A题\Solution\result2逼近速度.xlsx'
df2.to_excel(file2_path, index=False, header=False)
df3 = pd.DataFrame(table1)
file3_path = r'D:\Mathematical_Modeling\MCM2024\CUMCM2024Problems\A题\Solution\question2角度.xlsx'
